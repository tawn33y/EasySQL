...
use Tawn33y\Swift\Builder;
use Tawn33y\Swift\Database\ConfigurationStore;
...
$builder = new Builder(new Database(new ConfigurationStore(require 'config/database.php')));

$result = $builder->table('hello_world')
    ->where('id', '>', 2)
    ->orderBy('id', 'DESC')
    ->get(['id', 'name', 'random']);
